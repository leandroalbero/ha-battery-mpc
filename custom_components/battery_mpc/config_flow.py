    ...
    async def async_step_init(
        ...
        return self.async_show_form(
            ...
            data_schema=vol.Schema({
                ...
                vol.Required("soc_sensor_entity_id", default=d.get("soc_sensor_entity_id", "")): str,
                vol.Optional("pv_power_entity_id", default=d.get("pv_power_entity_id", "")): str,
                vol.Optional("load_sensor_entity_id", default=d.get("load_sensor_entity_id", "")): str,
                vol.Required("goodwe_operation_mode_entity_id", default=d.get("goodwe_operation_mode_entity_id", "")): str,
            }),
        )
